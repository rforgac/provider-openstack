...
type ClusterV1Parameters struct {
	...
	// +crossplane:generate:reference:type=github.com/rforgac/provider-openstack/apis/networking/v1alpha1.NetworkV2
	// +kubebuilder:validation:Optional
	...
	// +crossplane:generate:reference:type=github.com/rforgac/provider-openstack/apis/networking/v1alpha1.SubnetV2
	// +kubebuilder:validation:Optional
